...
const Sessions = () => {
    ...
    const tableRows = session === null ? "" : session.slice(0).reverse().map(({ tos, scramble, _id }) => {
        ...
        return (
            <>
                <tr key={_id}>
                    ...
                    <td className='ptr' align='left'><div className='del' onClick={() => { deleteTime(_id) }}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" stroke='red' className="bi bi-trash" viewBox="0 0 16 16">
